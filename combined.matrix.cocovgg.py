...
# CONFIG
model_type = 'coco-FRCNN-vgg16'  # choose between 'coco-FRCNN-resnet50' or 'coco-FRCNN-vgg16'
...
if __name__ == '__main__':
    ...
    if matrix_type == 'KF-All-COCO' and S_KF_All_COCO is not None and S_KG_55_COCO is not None:
        ...
        for e in weights:
            ...
            S_combined = (1 - e) * S_KF_All_COCO + e * S_KG_55_COCO
            ...
            det_boxes, det_labels, det_scores, true_boxes, true_labels, true_difficulties, true_areas = test_function_kg(
                 test_loader, model, settype, S, lk, bk, num_iterations, epsilon, num_classes - 1, topk
            )
            ...
            print(f"Results for weight of KF is = {1-e} and KG is = {e}:")
